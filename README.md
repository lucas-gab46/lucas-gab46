<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=00BFFF&height=120§ion=header"/>

# Olá, eu sou Lucas Gabriel! 👋

Estudante de **Bacharelado em Ciência da Computação** na **UFSCar**, apaixonado por **robótica**, **programação back-end** e **front-end**. Exploro simulações de robôs com o **grSim**, trabalho com lógica em C/C++ e Java, e desenvolvo interfaces com JavaScript e frontend. Sempre buscando aprender e criar soluções — de robôs a aplicações web!
...
<div style="display: inline-block">
  ...
  <img src="https://img.shields.io/badge/C++-17-00599C?logo=c%2B%2B" alt="C++">
  <img src="https://img.shields.io/badge/C-A8B9CC?logo=c" alt="C">
  <img src="https://img.shields.io/badge/Java-17-ED8B00?logo=java" alt="Java">
  <img src="https://img.shields.io/badge/JavaScript-ES6-F7DF1E?logo=javascript" alt="JavaScript">
  <img src="https://img.shields.io/badge/Git-F05032?logo=git&logoColor=white" alt="Git">
  <img src="https://img.shields.io/badge/Robotics-Enthusiast-green" alt="Robotics">
</div>
...
<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=00BFFF&height=120§ion=footer"/>
